...
class Category(models.Model):
    ...
    slug_name = models.SlugField(verbose_name="Alias normé",
                                 unique=True,
                                 blank=True)
...
class Article(models.Model):
    ...
    slug_title = models.SlugField(verbose_name="Alias normé",
                                  unique=True,
                                  blank=True)
    content = RichTextUploadingField("Corps de texte")
    ext_url = models.URLField("Lien externe",
                              blank=True)
    ...
    def get_absolute_url(self):
        return reverse('cms:view_article', kwargs={'slug': self.slug_title,
                                               'category': self.category.slug_name
                                               }
                       )
