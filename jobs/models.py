...
class GeorezoRSS(models.Model):
    id_rss = models.IntegerField("Identifiant du flux RSS",
                                 db_index=True,
                                 primary_key=True)
    title = models.CharField("Titre de l'offre",
    ...
    content = models.TextField("Contenu de l'offre",
                               blank=True, null=True)
    pub_date = models.DateTimeField("Publiée le",
                                    db_index=True,
                                    blank=True, null=True)
    created = models.DateTimeField("Ajoutée le",
                                   db_index=True,
                                   auto_now_add=True)
    updated = models.DateTimeField("Modifiée le",
                                   db_index=True,
                                   auto_now=True)
    source = models.BooleanField()
    to_update = models.BooleanField("Analyser de nouveau",
                                    db_index=True,
...
class GeorezoHisto(models.Model):
    id_forum = models.IntegerField(blank=True, null=True, editable=False)
    id_rss = models.IntegerField(blank=True, null=True, editable=False)
    title = models.TextField(blank=True, null=True, editable=False)
    pub_date = models.DateTimeField(blank=True, null=True, editable=False)
    contrat = models.TextField(blank=True, null=True, editable=False)
    visites = models.IntegerField(blank=True, null=True, editable=False)
    dpt1 = models.TextField(blank=True, null=True, editable=False)
    dpt2 = models.TextField(blank=True, null=True, editable=False)
    region = models.TextField(blank=True, null=True, editable=False)
    region_typ = models.TextField(blank=True, null=True, editable=False)
    ...
    class Meta:
        ...
        verbose_name_plural = "Historique des offres de GeoRezo"
        get_latest_by = "pub_date"
...
class Contract(models.Model):
    abbrv = models.CharField(max_length=20,
                             db_index=True,
                             unique=True,
                             primary_key=True,
                             verbose_name="Abbréviation")
    name = models.CharField(max_length=75,
                            verbose_name="Intitulé complet")
    comment = models.TextField(blank=True,
                               verbose_name="Commentaire")
    created = models.DateTimeField("Ajouté le",
                                   auto_now_add=True)
    updated = models.DateTimeField("Modifié le",
                                   auto_now=True)
...
class ContractVariations(models.Model):
    ...
    name = models.ForeignKey(Contract,
...
class Technology(models.Model):
    ...
    type_soft = models.CharField(max_length=50,
                                 choices=TYPE_SOFT,
                                 default=ND,
...
class TechnologyVariations(models.Model):
    ...
    label = models.CharField(max_length=200,
                             default=ND,
                             verbose_name="Variante du libellé")
    name = models.ForeignKey(Technology,
...
class JobPosition(models.Model):
    ...
    created = models.DateTimeField("Créé le",
                                   auto_now_add=True)
    updated = models.DateTimeField("Modifié le",
                                   auto_now=True)
...
class JobPositionVariations(models.Model):
    ...
    label = models.CharField(max_length=200,
                             default=ND,
                             verbose_name="Variante du libellé")
    name = models.ForeignKey(JobPosition,
...
class Offer(models.Model):
    id_rss = models.IntegerField(blank=True,
                                 db_index=True,
                                 unique=True)

    raw_offer = models.OneToOneField(GeorezoRSS,
                                     null=True,
                                     on_delete=models.SET_NULL,
                                     related_name='clean_offer')

    title = models.CharField("Titre", max_length=200,
                             validators=[MaxLengthValidator(200)])
    content = models.TextField("Contenu",
                               null=True)
    pub_date = models.DateTimeField("Date de publication sur le RSS",
                                    null=True,)
    week = models.IntegerField(verbose_name="Semaine de publication",
                               null=True,
    ...
    jobs_positions = models.ManyToManyField(JobPosition,
    ...
    def get_week_from_date_pub(self):
        if self.pub_date:
            return "{}{}".format(arrow.get(self.pub_date).isocalendar()[0],
                                 str(arrow.get(self.pub_date).isocalendar()[1])
                                 .zfill(2)
                                 )
        else:
            self.week.help_text
